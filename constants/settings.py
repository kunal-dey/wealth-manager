...
TODAY = datetime(2024, 6, 27) if DEBUG else datetime.now()
TRAINING_DATE = datetime(2024, 6, 27) if DEBUG else datetime.now()
...
DELIVERY_INITIAL_RETURN = 0.04
DELIVERY_INCREMENTAL_RETURN = 0.01
DAILY_MINIMUM_RETURN = 0.04

INTRADAY_INITIAL_RETURN = 0.04
INTRADAY_INCREMENTAL_RETURN = 0.01
